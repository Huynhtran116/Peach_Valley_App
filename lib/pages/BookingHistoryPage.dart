        ...
        builder: (ctx) => AlertDialog(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.receipt_long, color: Colors.red, size: 18),
                        ),
                    ...
                    if (booking != null) ...[
                      ...
                      _infoCancelRow(Icons.calendar_today, 'Nhận phòng', _formatDate(booking['NgayNhanPhong'])),
                      const SizedBox(height: 4),
                      _infoCancelRow(Icons.calendar_today, 'Trả phòng', _formatDate(booking['NgayTraPhong'])),
                    ],
                  ],
                ),
              ),
              const SizedBox(height: 12),
              const Text('⚠️ Sau khi hủy, đơn đặt phòng sẽ bị hủy và không thể khôi phục.',
          ...
          actions: [
            TextButton(
              ...
              child: const Text('Giữ lại', style: TextStyle(color: Color(0xFF49120F), fontSize: 14)),
            ),
            ElevatedButton(
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(response['message'] ?? 'Đơn #$maDatPhong đã được hủy',
  ...
  // 🔥 Helper row cho dialog hủy
    Widget _infoCancelRow(IconData icon, String label, String value) {
      return Row(
        children: [
          Icon(icon, size: 14, color: Colors.grey),
          const SizedBox(width: 8),
          Text('$label: ', style: const TextStyle(fontSize: 12, color: Colors.grey)),
          Text(value, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFF49120F))),
        ],
      );
    }
    ...
    Widget _buildBookingCard(dynamic booking) {
      ...
      print('📦 HoaDon: ${jsonEncode(hoaDon)}');
      print('📦 ConLai: ${hoaDon?['ConLai']}');
      print('📦 TongTien: ${hoaDon?['TongTien']}');
      print('📦 DaThanhToan: ${hoaDon?['DaThanhToan']}');
                  ...
                  if (hoaDon != null && tinhTrang != 4) ...[
                    ...
                    if ((hoaDon['PhanTramGiam'] ?? 0) > 0) ...[
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('Voucher ${hoaDon['TenKM'] ?? ''}', style: const TextStyle(fontSize: 12, color: Colors.green)),
                          Text('-${hoaDon['PhanTramGiam']}%', style: const TextStyle(fontSize: 12, color: Colors.green)),
                        ],
                      ),
                    ],
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Tổng thanh toán', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: Color(0xFF49120F))),
